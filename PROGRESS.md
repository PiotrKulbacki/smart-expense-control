...
5. **Split paragonów (Faza 9.0):** kod wdrożony (Faza 1 + 2); testy `receipt-scanner.service.test.ts` dodane; pozostaje ręczna weryfikacja E2E AI grouping na prawdziwym paragonie mieszanym.
